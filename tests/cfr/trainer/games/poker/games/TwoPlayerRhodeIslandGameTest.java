...
public class TwoPlayerRhodeIslandGameTest {
	...
	public final void startGameTest() {
		...
		assertTrue(TwoPlayerRhodeIslandGame.getActions().contains(DealAction.getInstance()));
	...
	public final void importGameTest() {
		...
		assertEquals(1, TwoPlayerRhodeIslandGameToBeCopied.getActions().size());
		assertTrue(TwoPlayerRhodeIslandGameToBeCopied.getActions().contains(DealAction.getInstance()));
	...
	public final void getNodeIdTest() {
		...
		assertEquals("[S, S, DEUCE]DEAL RAISE1", TwoPlayerRhodeIslandGame.getNodeIdWithActionMemory());
		assertEquals("[S, S, DEUCE]5 raisesAllowed : true", TwoPlayerRhodeIslandGame.getNodeIdWithGameState());
